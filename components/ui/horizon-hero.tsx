...
// Dynamic imports for postprocessing to avoid SSR issues
...
export const HorizonHero = () => {
  ...
  useEffect(() => {
    ...
    const initThree = async () => {
      ...
      // Dynamic import postprocessing
      const { EffectComposer: EC } = await import(
        "three/examples/jsm/postprocessing/EffectComposer.js" as string
      );
      const { RenderPass: RP } = await import(
        "three/examples/jsm/postprocessing/RenderPass.js" as string
      );
      const { UnrealBloomPass: UBP } = await import(
        "three/examples/jsm/postprocessing/UnrealBloomPass.js" as string
      );
      ...
      (refs.scene as THREE.Scene).fog = new THREE.FogExp2(0x000000, 0.00025);
    ...
    <div ref={containerRef} className="relative" style={{ height: `${(totalSections + 1) * 100}vh` }}>
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none">
          <h1
            ref={titleRef}
            className="font-display font-extrabold text-white uppercase tracking-[-0.04em] leading-none"
            style={{ fontSize: "clamp(4rem, 12vw, 10rem)" }}
          >
            HORIZON
          </h1>
          <div ref={subtitleRef} className="mt-6 text-center text-white/50 font-mono text-sm tracking-widest">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2">
          <span className="font-mono text-[9px] text-white/30 tracking-widest uppercase">Scroll</span>
          <div className="w-px h-8 bg-gradient-to-b from-white/20 to-transparent" />
        </div>

        <div className="absolute bottom-8 right-8 z-10 font-mono text-[10px] text-white/20">
